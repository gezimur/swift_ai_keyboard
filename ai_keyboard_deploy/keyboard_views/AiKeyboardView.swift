...
public struct AIKeyboardContentView: View {
    ...
    public init(insert_text: @escaping (String) -> Void, delete_text: @escaping () -> Void,) {
    ...
    public var body: some View {
        GeometryReader { geometry in
            ...
            let comfort_height = max(geometry.size.height * 0.9, 300)
